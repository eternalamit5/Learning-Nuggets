...
class ParticleFilter:
    ...
    def validate_state(self, state):
        """
        Validate the state. State values outside allowed ranges will be corrected for assuming a 'cyclic world'.
    ...
    def get_average_state(self):
        ...
        avg_theta = 0.0
        for weighted_sample in self.particles:
            avg_x += weighted_sample[0] / sum_weights * weighted_sample[1][0]   # how??
